...
const mitzvahSummary = async (prompt) => {
    //Takes in prompt, and returns the AI response.
    try {
...
const explainMitzvah = async (id) => {
    ...
    //Looking for Mitzvah, using find function, where mitzvah number is equal to ID provided in function as a param.
...
const aiSearch = async (query)=>{
    //Takes in query, and adds this to our AI prompt, returning response.
    try {
